...
// Seul validation.php est traduit dans lang/{locale}/ — voir la note dans
// lang/en/validation.php. Cette locale corrige un manque réel : l'app est
// entièrement française (tous les abort() métier sont en français en dur)
// mais APP_LOCALE valait 'en' et aucun fichier fr/ n'existait avant ce
// travail — une erreur de validation Laravel (pas un abort() métier
// personnalisé) sortait donc en anglais malgré une UI 100% française.
...
return [
    ...
    'password' => [
        ...
        'uncompromised' => "La valeur donnée pour :attribute est apparue dans une fuite de données. Merci de choisir une autre valeur pour :attribute.",
    ],
